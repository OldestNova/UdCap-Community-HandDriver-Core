        ...
        if (caliStat == UDCAP_V1_HAND_CALI_STAT_COMPLETED) {
            ...
            if (udState == UdState::UD_INIT_STATE_LINKED) {
                ...
                }
                {
                    ...
                    packetSkeleton.skeletonQuaternion.thumbFinger.intermediate = eulerToQuaternion(0, conThumb2, 0);
                    packetSkeleton.skeletonQuaternion.thumbFinger.proximal = eulerToQuaternion(0,conThumb3, 0);
